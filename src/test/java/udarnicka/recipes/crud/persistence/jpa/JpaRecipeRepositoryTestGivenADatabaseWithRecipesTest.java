...
public class JpaRecipeRepositoryTestGivenADatabaseWithRecipesTest extends RecipeRepositoryAbstractBaseTestGivenADatabaseWithRecipes<RecipeJpaEntity, SpringDataRecipeRepository> {
